<script lang="ts">
	...
	import { formatSchema, generateCurlExample, generateTypeScriptExample } from '../utils/openapi-formatter';
		...
		{#if expandedSections.responses}
			<div class="openapi-doc__responses">
				{#each Object.entries(endpoint.responses) as [statusCode, response]}
					<details class="openapi-doc__response" open={statusCode === '200' || statusCode === '201'}>
...
<style>
	...
	.openapi-doc__example-tab {
		...
		font-size: 0.875rem;
		font-family: var(--md-font-sans, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen,
