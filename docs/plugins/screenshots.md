...
Here are actual screenshots generated by this documentation system (dogfooding!):

### Git Status Output

![Git status command output](/screenshots/examples/git-status.svg)
...
![NPM test output](/screenshots/examples/pnpm-test.svg)

### Git Log

![Git log --oneline output](/screenshots/examples/git-log.svg)

### File System Listing

![Directory listing of plugins](/screenshots/examples/ls-plugins.svg)

### TypeScript Execution

![Running TypeScript with tsx](/screenshots/examples/tsx-generate.svg)

### Package.json Contents

![Viewing package.json](/screenshots/examples/package-json.svg)
